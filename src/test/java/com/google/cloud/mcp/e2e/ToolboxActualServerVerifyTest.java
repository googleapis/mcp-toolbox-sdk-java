...
public class ToolboxActualServerVerifyTest {
  ...
  public void testActualServerExampleFlow() throws Exception {
    ...
    assertNotNull(
        compiler,
        "System Java compiler is not available. Please run tests using a JDK, not a JRE.");
