...
public interface McpToolboxClient {
    ...
    /**
     * Loads the toolset (all available tools) from the MCP Server.
     * Alias for {@link #listTools()}.
     */
     ...
     */
    CompletableFuture<ToolResult> invokeTool(String toolName, Map<String, Object> arguments, Map<String, String> extraHeaders);
